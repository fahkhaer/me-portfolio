  ...
  return (
    <>
      <section className='relative flex h-screen w-full items-center justify-center overflow-hidden bg-[#A53860F0] px-6'>
        {/* kiri - tech logo */}
        <div className='absolute top-55 left-10 flex -translate-y-1/2 flex-col items-center gap-5'>
        ...
        <div className='relative flex flex-col items-center text-center'>
          {/* Junior */}
          <p className='font-bonheur absolute -top-16 -left-24 -rotate-12 text-[113px] leading-none text-white'>
            Junior
          </p>

          {/* FRONTEND DEVELOPER */}
          <div className='font-anton text-secondary-100 leading-[0.9]'>
          ...
          <div className='mt-10 flex items-center gap-3'>
            <Button
              className='border-primary-300 rounded-full border bg-transparent text-white hover:bg-[#E26190]/30'
              variant='secondary'
            >
              <Icon
        ...
        <div className='absolute top-1/2 right-10 flex -translate-y-1/2 flex-col items-end gap-4'>
          <Statistics />
          <Button className='bg-secondary-100 flex h-14 w-56 items-center justify-between rounded-full px-4 py-2 hover:bg-[#D9A23F]'>
